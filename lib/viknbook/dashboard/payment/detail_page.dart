                ...
                children: <TextSpan>[
                  ...
                  TextSpan(
                      ...
                      style: customisedStyleBold(context,
                          const Color(0xff595959), FontWeight.w400, 12.0)),
                  TextSpan(
                      text: '1000',
                      style: customisedStyleBold(
                          context,
                  ...
                  text: TextSpan(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                          text: 'SAR ',
                          style: customisedStyleBold(context,
                              const Color(0xff7d7d7d), FontWeight.w400, 12.0)),
                      TextSpan(
                          text: '0.00 ',
                          style: customisedStyleBold(
                              context,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          "Delete",
                          style: customisedStyleBold(context, Color(0xffC80000),
                    ...
                    Text("View History",
                        style: customisedStyleBold(
                            context, Color(0xff0A9EF3), FontWeight.w400, 15.0))
                  ],
                )
              ],
            )),
