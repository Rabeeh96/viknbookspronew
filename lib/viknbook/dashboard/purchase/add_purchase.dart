...
import '../sales/detail/add_customer.dart';
import 'detail/select_product.dart';
...
class _AddPurchaseState extends State<AddPurchase> {
  ...
  TextEditingController refNoSupplyController = TextEditingController();
            ...
            child: Column(
              children: [
                ...
                Container(
                  height: MediaQuery.of(context).size.height / 20,
                  child: TextField(
                    controller: placeOfSupplyController,
                    style: customisedStyleBold(
                        context,
                        themeChangeController.isDarkMode.value
                            ? Colors.white
                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                          ...
                          decoration: TextFieldStyle.textFieldType(
                            context,
                            hintTextStr: "Due date",
                            labelTextStr: "Due date",
                          ),
                        ),
                      ),
                      Container(
                ...
                Container(
                  height: MediaQuery.of(context).size.height / 20,
                  child: TextField(
                    controller: refNoSupplyController,
                    style: customisedStyleBold(
                        context,
                        themeChangeController.isDarkMode.value
                            ? Colors.white
                    ...
                    children: [
                      Container(
                        ...
                        child: TextField(
                          ...
                          decoration: TextFieldStyle.textFieldType(
                            context,
                            hintTextStr: "Reference date",
                            labelTextStr: "Reference date",
                          ),
                        ),
                      ),
                      Container(
