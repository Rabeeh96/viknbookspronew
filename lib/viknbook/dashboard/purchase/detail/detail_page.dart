...
class DetailPagePurchase extends StatefulWidget {
  // String? masterType;
  // String? masterID;
  //DetailPage({super.key,required this.masterID,required this.masterType});

  @override
  State<DetailPagePurchase> createState() => _DetailPagePurchaseState();
}

class _DetailPagePurchaseState extends State<DetailPagePurchase> {
  int status = 1;
